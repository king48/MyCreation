...
public class Background
{
	...
	bannana.fillRect (0, 300, 640, 300); // Makes the ground
    }
	...
	bannana.fillArc (0, 200, 225, 200, 0, 180); // Makes Patricks home
    }
	...
	bannana.fillRect (280, 80, 120, 220); // Creates the main body of the hose
	bannana.fillRect (300, 64, 80, 16);
	bannana.fillRect (260, 110, 20, 100);
	bannana.fillRect (400, 110, 20, 100);
	bannana.setColor (Color.black);

	bannana.fillRect (318, 246, 40, 55);
	bannana.fillOval (300, 120, 35, 35);
	bannana.fillOval (350, 120, 35, 35);
	...
	bannana.fillArc (460, 100, 180, 400, 0, 180); // Creats the actual 'pineapple'
	bannana.setColor (new Color (181, 181, 181)); // Creates the grey color for the door and windows
	bannana.fillArc (525, 250, 50, 100, 0, 180); // Creates the door to the 'pineapple'
	bannana.fillOval (500, 170, 30, 30); // Creates the window to the 'pineapple'
	bannana.fillOval (590, 230, 30, 30); // Creates the second window to the 'pineapple'
    }
